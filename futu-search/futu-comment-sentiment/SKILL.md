...
When both `futu-comment-sentiment` and `moomoo-comment-sentiment` are installed, append a platform source line after the disclaimer, matching the user's language:
